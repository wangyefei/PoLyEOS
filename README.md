...
One easy way to do this is to install [Anaconda](https://www.anaconda.com/download/) then open Anaconda prompt and type "pip install uncertainties". Then you can launch the program by runing Main.py. 
